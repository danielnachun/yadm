# Generated by Powerlevel10k configuration wizard on 2020-05-16 at 21:22 PDT.
...
() {
  ...
  function p10k-on-pre-prompt() { p10k display '1/right/time'=hide }
  function p10k-on-post-prompt() { p10k display '1/right/time'=show }
